...
def generate_launch_description():
    ...
    gz_resource_path = SetEnvironmentVariable(
        ...
        value=':'.join([
            os.path.join(pkg_turtlebot4_gz_bringup, 'models'), ## adding models for local worlds to project
            os.path.join(pkg_turtlebot4_gz_bringup, 'worlds'),
            os.path.join(pkg_irobot_create_gz_bringup, 'models'), ## adding models for local worlds to project
